...
var element=obj.map((product,index)=>{
  let result="";
  if(product.status)
  {
    result=<Product key={product.id} name={product.name} price={product.price} urlImage={product.url}></Product>
  }
  return(result);
});
 ...
 <div className="row w-50 mx-auto p-2">
   <div className="col-12">
     ...
     <button type="button" className="btn-primary" onClick={this.showText}>Search</button>
   </div>
 </div>
        <div className="container">
          <div className="row">     
...
// "https://cdn.hoanghamobile.com/i/productlist/dsp/Uploads/2021/09/15/image-removebg-preview-15.png"
export default App;
